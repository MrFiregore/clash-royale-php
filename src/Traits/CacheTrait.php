<?php
    ...
    trait CacheTrait
    {
        ...
        {
            if (empty($this->getParams()) || 1 == count($this->getParams())) {
        ...
        public function setExtension (array $querys)
        {
        ...
        {
            $base_file       = preg_replace('/\/?(:(tag|cc)|{(tag|tags|name)})\/?|(?<!^)\//m', '-', substr($this->getEndPoint(), 1));
        ...
        {
            return false !== strpos($this->getEndPoint(), ':tag') || false !== strpos($this->getEndPoint(), '{tag')|| false !== strpos($this->getEndPoint(), '{name');
        }
        
        public function optParams ()
        {
            return false !== strpos($this->getEndPoint(), ':cc');
        }
